...
/* Create a modifer that checks if the msg.sender is the owner of the contract */
   ...
   */
   ...
   require(items[sku].state == 1 && items[sku].buyer !=address(0));
   _;
   }
   modifier shipped(uint sku){
   require(items[sku].state == 2 && items[sku].buyer !=address(0));
   _;
   }
  
   modifier received(uint sku){
   require(items[sku].state == 3 && items[sku].buyer !=address(0));
   _;
   }
